        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-4">
              {/* Preview Notice */}
              <div className="bg-emerald-900 bg-opacity-30 border border-emerald-700 rounded-lg p-6 mb-8">
                <h3 className="text-emerald-400 text-lg font-bold mb-2">Preview Mode</h3>
                <p className="text-emerald-200 mb-4">
                  You're viewing a preview of this blog post. Some features may be limited in preview mode.
                </p>
                <div className="flex space-x-3">
                  <Link href={`/blog/${post.slug}`} className="text-emerald-400 hover:text-emerald-300 text-sm font-medium">
